...
public class MovieDataJsonUtils {
    public static Movie[] getStringsFromJson(Context context, String movieJsonString) throws JSONException {
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            Movie item = new Movie(id, title, release_date, poster_path, vote_average, overview);
            resultArray[i] = item;
        }
